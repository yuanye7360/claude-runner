  ...
  <div class="flex flex-1 flex-col overflow-auto p-6">
    ...
    <div class="mb-6 grid grid-cols-3 gap-3">
      <NuxtLink
        ...
        style="background: rgb(139 92 246 / 4%); border-color: rgb(139 92 246 / 10%)"
      >
      ...
      <NuxtLink
        to="/pr-runner"
        class="group rounded-[10px] border p-4 transition-colors duration-150"
        style="background: rgb(6 182 212 / 4%); border-color: rgb(6 182 212 / 10%)"
      >
        <div class="mb-2 flex items-center justify-between">
      ...
      <NuxtLink
        to="/pr-review"
        class="group rounded-[10px] border p-4 transition-colors duration-150"
        style="background: rgb(34 197 94 / 4%); border-color: rgb(34 197 94 / 10%)"
      >
        <div class="mb-2 flex items-center justify-between">
