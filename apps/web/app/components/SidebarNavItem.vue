...
<template>
  <NuxtLink
    ...
    :class="
      isActive
        ? 'border-l-2 border-[#8b5cf6] bg-[rgba(139,92,246,0.08)]'
        : 'border-l-2 border-transparent hover:translate-x-0.5 hover:bg-[rgba(255,255,255,0.04)]'
    "
  >
    <UIcon
      :name="icon"
      ...
      :class="
        isActive ? 'text-[#8b5cf6]' : 'text-[#555] group-hover:text-[#aaa]'
      "
    />
