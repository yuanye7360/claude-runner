...
import { getPackages } from '@nuxtship/node-utils';
...
const DEFAULT_CONFIG = {
  ...
  ignoreMatches: [
    ...
    '@nuxtjs/*',
    '@tailwindcss/*',
    'postcss', // PostCSS 是 Nuxt 的运行时依赖
  ],
  // 需要忽略的包
  ignorePackages: [
    '@nuxtship/commitlint-config',
    '@nuxtship/eslint-config',
    '@nuxtship/node-utils',
    '@nuxtship/prettier-config',
    '@nuxtship/stylelint-config',
    '@nuxtship/tsconfig',
    '@nuxtship/vsh',
  ],
  // 需要忽略的文件模式
